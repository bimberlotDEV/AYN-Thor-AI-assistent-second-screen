...
- the complete Ask/Wiki/Saved/Games/More interface inside the secondary-display activity;
...
- per-game conversation management with new/open/rename/delete flows plus answer copy, retry, bookmark, and checklist actions;
- explicit 14-message context trimming and selectable 512/900/1500 output-token limits for cost control.
...
For a long-lived signed APK, upgrades, and private sharing, follow [private release and distribution](docs/release-and-distribution.md). Also see [privacy and security](docs/privacy-security.md), [troubleshooting and known limitations](docs/troubleshooting.md), and the [release checklist](docs/release-checklist.md).
